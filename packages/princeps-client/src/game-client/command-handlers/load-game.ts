...
export class LoadGame extends AbstractCommandHandler<LoadGamePayload, ClientCommand> {
    ...
    constructor(private gameCtrl: GameController, private commandsDispatcher: CommandDispatcher, private nickname: string) {
    ...
    handleCommand(payload: LoadGamePayload) {
        ...
        this.commandsDispatcher.updateNickname(this.nickname);
    }
}